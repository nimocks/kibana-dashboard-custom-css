...
@-webkit-keyframes focusRingAnimate {
  0% {
    -webkit-box-shadow: 0 0 0 6px rgba(35, 140, 255, 0);
            box-shadow: 0 0 0 6px rgba(35, 140, 255, 0); }
  100% {
...
@-webkit-keyframes focusRingAnimateLarge {
  0% {
    -webkit-box-shadow: 0 0 0 10px rgba(35, 140, 255, 0);
            box-shadow: 0 0 0 10px rgba(35, 140, 255, 0); }
  100% {
    -webkit-box-shadow: 0 0 0 4px rgba(35, 140, 255, 0.3);
            box-shadow: 0 0 0 4px rgba(35, 140, 255, 0.3); } }
...
.euiBetaBadge {
  ...
  padding: 0 16px;
  border-radius: 24px;
  -webkit-box-shadow: inset 0 0 0 1px #343741;
...
.euiBottomBar {
  -webkit-box-shadow: 0 0 0.8px rgba(0, 0, 0, 0.15), 0 0 2px rgba(0, 0, 0, 0.1), 0 0 5px rgba(0, 0, 0, 0.1), 0 0 17px rgba(0, 0, 0, 0.075);
...
.euiButton {
  ...
  .euiButton:disabled {
    ...
    .euiButton:disabled .euiButton__spinner {
      border-color: #238CFF currentColor currentColor currentColor; }
...
.euiButtonIcon--subdued {
  ...
  .euiButtonIcon--subdued:focus {
    background-color: rgba(129, 133, 143, 0.1); }
...
.euiButtonGroup__toggle {
  ...
  .euiButtonGroup__toggle[class*='checked'] {
    ...
    .euiButtonGroup__toggle[class*='checked'] + [class*='checked'] {
      -webkit-box-shadow: -1px 0 0 rgba(29, 30, 36, 0.1);
...
.euiBreadcrumb__collapsedBadge {
  height: 16px;
  margin-top: -6px;
  background-color: rgba(212, 218, 229, 0.15); }
...
.euiCodeBlock {
  ...
  .euiCodeBlock .hljs-deletion {
    ...
    margin-left: -4px; }
  .euiCodeBlock .hljs-addition {
    -webkit-box-shadow: -4px 0 #54B399;
            box-shadow: -4px 0 #54B399; }
  .euiCodeBlock .hljs-deletion {
    -webkit-box-shadow: -4px 0 #F66;
...
.euiCollapsibleNav {
  border-left: none;
  -webkit-box-shadow: 0 2.7px 9px rgba(0, 0, 0, 0.325), 0 9.4px 24px rgba(0, 0, 0, 0.225), 0 21.8px 43px rgba(0, 0, 0, 0.2);
...
@-webkit-keyframes euiCollapsibleNavGroupDarkFocusRingAnimate {
  0% {
    -webkit-box-shadow: 0 0 0 6px rgba(35, 140, 255, 0);
            box-shadow: 0 0 0 6px rgba(35, 140, 255, 0); }
  100% {
    -webkit-box-shadow: 0 0 0 3px #238CFF;
            box-shadow: 0 0 0 3px #238CFF; } }
...
.euiControlBar {
  ...
  -webkit-box-direction: normal;
      -ms-flex-direction: column;
          flex-direction: column;
  -webkit-box-shadow: inset 0 40px 0 #000, inset 0 600rem 0 #1a1b20;
          box-shadow: inset 0 40px 0 #000, inset 0 600rem 0 #1a1b20;
  bottom: 0;
  -webkit-transform: translateY(0);
          transform: translateY(0);
  height: 40px;
...
.euiControlBar__tab {
  ...
  .euiControlBar__tab.euiControlBar__tab--active {
    background-color: #1a1b20;
    -webkit-box-shadow: inset 0 4px 0 #2e92ff;
            box-shadow: inset 0 4px 0 #2e92ff;
    color: #2e92ff; }
...
.react-datepicker__navigation {
  ...
  .react-datepicker__navigation--previous {
    ...
    .react-datepicker__navigation--previous:hover {
      background-color: #25262E;
      -webkit-box-shadow: 0 0 0 2px #25262E;
              box-shadow: 0 0 0 2px #25262E; }
    .react-datepicker__navigation--previous:focus {
      background-color: #232635;
      -webkit-box-shadow: 0 0 0 2px #232635;
              box-shadow: 0 0 0 2px #232635; }
...
.react-datepicker__day {
  ...
  .react-datepicker__day--in-selecting-range:not(.react-datepicker__day--in-range) {
    background-color: rgba(35, 140, 255, 0.5); }
...
.euiDataGridHeaderCell {
  ...
  .euiDataGridHeaderCell:focus {
    ...
    -webkit-box-shadow: 0 0 0 2px rgba(35, 140, 255, 0.3);
            box-shadow: 0 0 0 2px rgba(35, 140, 255, 0.3);
    border-radius: 1px;
    z-index: 2; }
...
.euiFacetButton {
  ...
  .euiFacetButton:focus {
    background-color: #232635;
    -webkit-box-shadow: -4px 0 #232635, 4px 0 #232635;
            box-shadow: -4px 0 #232635, 4px 0 #232635; }
...
.euiFormControlLayout--group {
  ...
  .euiFormControlLayout--group .euiButtonIcon {
    ...
    .euiFormControlLayout--group .euiButtonIcon:focus {
      -webkit-box-shadow: inset 0 0 0 2px rgba(35, 140, 255, 0.3);
              box-shadow: inset 0 0 0 2px rgba(35, 140, 255, 0.3); }
...
.euiRangeLevel--primary {
  background-color: rgba(35, 140, 255, 0.3); }
...
.euiHeader--dark {
  ...
  .euiHeader--dark .euiHeaderSectionItemButton__notification {
    -webkit-box-shadow: 0 0 0 1px #131317;
...
.euiHeaderSectionItemButton__notification {
  ...
  top: 9%;
  right: 9%;
  -webkit-box-shadow: 0 0 0 1px #1D1E24;
...
.euiLink {
  ...
  .euiLink.euiLink--subdued {
    ...
    .euiLink.euiLink--subdued:focus {
      outline: solid 3px rgba(129, 133, 143, 0.1);
      background-color: rgba(129, 133, 143, 0.1); }
  .euiLink.euiLink--primary {
    ...
    .euiLink.euiLink--primary:focus {
      outline: solid 3px rgba(35, 140, 255, 0.1);
      background-color: rgba(35, 140, 255, 0.1); }
  .euiLink.euiLink--secondary {
    ...
    .euiLink.euiLink--secondary:focus {
      outline: solid 3px rgba(125, 226, 209, 0.1);
      background-color: rgba(125, 226, 209, 0.1); }
  .euiLink.euiLink--accent {
    ...
    .euiLink.euiLink--accent:focus {
      outline: solid 3px rgba(249, 144, 192, 0.1);
      background-color: rgba(249, 144, 192, 0.1); }
  .euiLink.euiLink--warning {
    ...
    .euiLink.euiLink--warning:focus {
      outline: solid 3px rgba(255, 206, 122, 0.1);
      background-color: rgba(255, 206, 122, 0.1); }
  .euiLink.euiLink--danger {
    ...
    .euiLink.euiLink--danger:focus {
      outline: solid 3px rgba(255, 117, 117, 0.1);
      background-color: rgba(255, 117, 117, 0.1); }
  .euiLink.euiLink--text {
    ...
    .euiLink.euiLink--text:focus {
      outline: solid 3px rgba(223, 229, 239, 0.1);
      background-color: rgba(223, 229, 239, 0.1); }
...
.euiLoadingContent__singleLineBackground {
  ...
  width: 220%;
  height: 100%;
  background: -webkit-gradient(linear, left top, right top, color-stop(45%, #2e3039), color-stop(50%, #282a31), color-stop(55%, #2e3039));
...
.euiLoadingSpinner {
  ...
  border-color: #238CFF #343741 #343741 #343741;
...
.euiTreeView__nodeInner {
  ...
  .euiTreeView__nodeInner:focus {
    -webkit-box-shadow: inset 0 0 0 1px rgba(35, 140, 255, 0.3);
            box-shadow: inset 0 0 0 1px rgba(35, 140, 255, 0.3); }
...
.euiStepHorizontal-isSelected .euiStepHorizontal__number:not([class*='danger']):not([class*='warning']) {
  -webkit-box-shadow: 0 0.8px 0.8px rgba(57, 141, 233, 0.1), 0 2.3px 2px rgba(57, 141, 233, 0.075);
          box-shadow: 0 0.8px 0.8px rgba(57, 141, 233, 0.1), 0 2.3px 2px rgba(57, 141, 233, 0.075); }
...
.euiTableRow-isClickable:hover {
  background-color: rgba(35, 140, 255, 0.05);
  cursor: pointer; }
...
.euiToken--euiColorVis0 {
  ...
  .euiToken--euiColorVis0.euiToken--light {
    color: #54B399;
    background-color: #19362e;
    -webkit-box-shadow: inset 0 0 0 1px #22483d;
...
.euiToken--euiColorVis1 {
  ...
  .euiToken--euiColorVis1.euiToken--light {
    color: #6897c3;
    background-color: #1d2c3a;
    -webkit-box-shadow: inset 0 0 0 1px #263a4d;
...
.euiToken--euiColorVis2 {
  ...
  .euiToken--euiColorVis2.euiToken--light {
    color: #d77092;
    background-color: #3f1d28;
    -webkit-box-shadow: inset 0 0 0 1px #542636;
...
.euiToken--euiColorVis4 {
  ...
  .euiToken--euiColorVis4.euiToken--light {
    color: #CA8EAE;
    background-color: #3d2b34;
    -webkit-box-shadow: inset 0 0 0 1px #513946;
...
.euiToken--euiColorVis5 {
  ...
  .euiToken--euiColorVis5.euiToken--light {
    color: #D6BF57;
    background-color: #40391a;
    -webkit-box-shadow: inset 0 0 0 1px #564c23;
...
.euiToken--euiColorVis6 {
  ...
  .euiToken--euiColorVis6.euiToken--light {
    color: #B9A888;
    background-color: #383229;
    -webkit-box-shadow: inset 0 0 0 1px #4a4336;
...
.euiToken--euiColorVis7 {
  ...
  .euiToken--euiColorVis7.euiToken--light {
    color: #DA8B45;
    background-color: #412a15;
    -webkit-box-shadow: inset 0 0 0 1px #57381c;
...
.euiToken--euiColorVis8 {
  ...
  .euiToken--euiColorVis8.euiToken--light {
    color: #b67b6e;
    background-color: #331e1a;
    -webkit-box-shadow: inset 0 0 0 1px #442822;
...
.euiToken--euiColorVis9 {
  ...
  .euiToken--euiColorVis9.euiToken--light {
    color: #e86e55;
    background-color: #451f17;
    -webkit-box-shadow: inset 0 0 0 1px #5c291e;
...
.euiToken--gray {
  ...
  .euiToken--gray.euiToken--light {
    ...
    -webkit-box-shadow: inset 0 0 0 1px #212429;
...
.euiText {
  ...
  .euiText a:not([class]) {
    ...
    .euiText a:not([class]):focus {
      text-decoration: underline;
      outline: solid 3px rgba(27, 169, 245, 0.1);
...
.euiButton--primary {
  ...
  .euiButton--primary:enabled:hover, .euiButton--primary:enabled:focus {
    background-color: rgba(35, 140, 255, 0.35); }
...
.euiButton--text {
  ...
  .euiButton--text:enabled:hover, .euiButton--text:enabled:focus {
    background-color: rgba(152, 162, 179, 0.35); }
