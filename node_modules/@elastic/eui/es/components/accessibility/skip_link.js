...
export var EuiSkipLink = function EuiSkipLink(_ref) {
  ...
  var classes = classNames('euiSkipLink', ["euiSkipLink--".concat(position)], className);
  return React.createElement(EuiScreenReaderOnly, {
    showOnFocus: true
  }, React.createElement(EuiButton, _extends({
    className: classes,
...
EuiSkipLink.__docgenInfo = {
  ...
  "props": {
    "position": {
      ...
      "required": false,
      "description": "If true, the link will be fixed to the top left of the viewport"
    },
    "destinationId": {
      "type": {
        "name": "string"
    ...
    "textProps": {
      ...
      "required": false,
      "description": "Object of props passed to the <span/> wrapping the component's {children}"
    },
    "className": {
      "type": {
        "name": "string"
