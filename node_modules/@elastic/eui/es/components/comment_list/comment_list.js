...
export var EuiCommentList = function EuiCommentList(_ref) {
  ...
  if (comments) {
    commentElements = comments.map(function (item, index) {
      return React.createElement(EuiComment, _extends({
        key: index
      }, item));
    });
  }
