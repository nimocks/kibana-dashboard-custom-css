 ...
 * under the License.
 */
import React, { Fragment, useMemo } from 'react'; // @ts-ignore-next-line
...
var providedPopoverContents = {
  json: function json(_ref) {
    ...
    return React.createElement(EuiCodeBlock, {
      isCopyable: true,
...
export var EuiDataGridBody = function EuiDataGridBody(props) {
  ...
  var rows = useMemo(function () {
    return visibleRowIndices.map(function (rowIndex, i) {
      ...
      return React.createElement(EuiDataGridDataRow, {
        key: rowIndex,
  ...
  return React.createElement(Fragment, null, rows);
};
