...
function (_Component) {
  ...
  _createClass(EuiQuickSelect, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("fieldset", null, _react.default.createElement(_i18n.EuiI18n, {
        ...
        return (// Legend needs to be the first thing in a fieldset, but we want the visible title within the flex.
          ...
          _react.default.createElement(_accessibility.EuiScreenReaderOnly, null, _react.default.createElement("legend", {
            id: legendId,
        ...
        return _react.default.createElement(_form.EuiFieldNumber, {
          compressed: true,
          onKeyDown: _this2.handleKeyDown,
          "aria-describedby": "".concat(timeSelectionId, " ").concat(legendId),
