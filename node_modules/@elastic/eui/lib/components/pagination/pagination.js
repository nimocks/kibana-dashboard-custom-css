...
var EuiPagination = function EuiPagination(_ref) {
  ...
  var PaginationButton = function PaginationButton(_ref2) {
    ...
    var button = _react.default.createElement(_pagination_button.EuiPaginationButton, _extends({
  ...
  for (var i = firstPageInRange, index = 0; i < lastPageInRange; i++, index++) {
    pages.push(_react.default.createElement(PaginationButton, {
      pageIndex: i,
      key: i
    }));
  }
  ...
  var previousButton = _react.default.createElement(_i18n.EuiI18n, {
    ...
    return _react.default.createElement(_i18n.EuiI18n, {
      ...
      return _react.default.createElement(_button.EuiButtonIcon, _extends({
        onClick: function onClick(e) {
  ...
  if (firstPageInRange > 0) {
    firstPageButtons.push(_react.default.createElement(PaginationButton, {
      pageIndex: 0,
      key: 0
    }));
  ...
  if (lastPageInRange < pageCount) {
    if (lastPageInRange + 1 === pageCount - 1) {
      lastPageButtons.push(_react.default.createElement(PaginationButton, {
  ...
  if (compressed) {
    var firstPageButtonCompressed = _react.default.createElement(PaginationButton, {
      pageIndex: activePage,
      inList: false
    });

    var lastPageButtonCompressed = _react.default.createElement(PaginationButton, {
      pageIndex: pageCount,
      inList: false
    });
    ...
    return _react.default.createElement("nav", _extends({
      className: classes
    }, rest), previousButton, _react.default.createElement(_text.EuiText, {
      size: "s",
  ...
  var accessibleName = _objectSpread({}, rest['aria-label'] && {
  ...
  return _react.default.createElement("nav", _extends({
    className: classes
  }, rest), previousButton, _react.default.createElement("ul", _extends({}, accessibleName, {
...
EuiPagination.__docgenInfo = {
  ...
  "props": {
    ...
    "aria-controls": {
      ...
      "required": false,
      "description": "If passed in, passes value through to each button to set aria-controls"
    }
  }
};