  ...
  _createClass(FieldValueSelectionFilter, [{
    ...
    value: function renderSearchBox() {
      ...
      if (this.state.options && this.state.options.all.length >= threshold) {
        ...
        return _react.default.createElement(_popover.EuiPopoverTitle, null, _react.default.createElement(_field_search.EuiFieldSearch, {
    ...
    value: function renderLoader() {
      ...
      }, _react.default.createElement(_loading.EuiLoadingChart, {
        size: "m"
