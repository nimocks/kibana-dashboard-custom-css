...
var EuiSkipLink = function EuiSkipLink(_ref) {
  ...
  var classes = (0, _classnames.default)('euiSkipLink', ["euiSkipLink--".concat(position)], className);
  return _react.default.createElement(_screen_reader.EuiScreenReaderOnly, {
    showOnFocus: true
