...
function useDetectSchema(inMemory, inMemoryValues, schemaDetectors, definedColumnSchemas, autoDetectSchema) {
  var schema = (0, _react.useMemo)(function () {
    ...
    var columnIdsWithDefinedSchemas = new Set([].concat((0, _toConsumableArray2.default)(inMemory && inMemory.skipColumns || []), (0, _toConsumableArray2.default)(Object.keys(definedColumnSchemas))));
