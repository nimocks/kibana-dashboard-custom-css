...
function (_Component) {
  ...
  function EuiDualRange() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(EuiDualRange)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  (0, _createClass2.default)(EuiDualRange, [{
    ...
    value: function render() {
      ...
      var minInput = !!showInput ? _react.default.createElement(_range_input.EuiRangeInput // Overridable props
      , (0, _extends2.default)({
      ...
      var maxInput = !!showInput ? _react.default.createElement(_range_input.EuiRangeInput // Overridable props
      , (0, _extends2.default)({
        "aria-describedby": this.props['aria-describedby'],
        "aria-label": this.props['aria-label']
      }, maxInputProps, {
