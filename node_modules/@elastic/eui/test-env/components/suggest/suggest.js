...
var EuiSuggest = function EuiSuggest(props) {
  ...
  var suggestionList = suggestions.map(function (item, index) {
    return _react.default.createElement(_suggest_item.EuiSuggestItem, {
      type: item.type,
      key: index,
      label: item.label,
  ...
  var suggestInput = _react.default.createElement(_suggest_input.EuiSuggestInput, (0, _extends2.default)({
    status: status,
