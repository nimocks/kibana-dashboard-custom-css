...
function (_Component) {
  ...
  function EuiGlobalToastList() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(EuiGlobalToastList)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "dismissToast", function (toast) {
      ...
      _this.setState(function (prevState) {
        var toastIdToDismissedMap = _objectSpread({}, prevState.toastIdToDismissedMap, (0, _defineProperty2.default)({}, toast.id, true));
  ...
  (0, _createClass2.default)(EuiGlobalToastList, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          rest = (0, _objectWithoutProperties2.default)(_this$props, ["className", "toasts", "dismissToast", "toastLifeTimeMs"]);
      var renderedToasts = toasts.map(function (toast) {
        ...
        }, _react.default.createElement(_toast.EuiToast, (0, _extends2.default)({
